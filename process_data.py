...
def ols_fit(x_tr, y_tr, x_pred, years_list, ci=CI_LEVEL):
    ...
    n = len(xc)
    if n < MIN_TRAIN_YRS or not np.isfinite(x_pred): return None
...
def get_tx(cotton):
    ...
    return tx.set_index("mkt_year")["abandonment"]
...
def main():
    ...
    ab_tx = cotton[cotton["geography"]=="TX"].set_index("mkt_year")["abandonment"]
